...
const Energie: React.FC<EnergieProps> = ({ isAdmin = false, onNavigate }) => {
  ...
  const [images, setImages] = useState<string[]>([
    "https://github.com/kyqdcn/Website-Y-Architektur/blob/main/public/images/Energie-Cover.jpg?raw=true",
    "https://github.com/kyqdcn/Website-Y-Architektur/blob/main/public/images/Energie-1.jpg?raw=true",
    "https://github.com/kyqdcn/Website-Y-Architektur/blob/main/public/images/Energie-2.jpg?raw=true",
  ]);
