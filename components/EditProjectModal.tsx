...
const EditProjectModal: React.FC<EditProjectModalProps> = ({ isOpen, onClose, project, onUpdate }) => {
  ...
  // Chinese fields
  const [titleZh, setTitleZh] = useState(project.titleZh || '');
  const [locationZh, setLocationZh] = useState(project.locationZh || '');
  const [subtitleZh, setSubtitleZh] = useState(project.subtitleZh || '');
  const [categoryZh, setCategoryZh] = useState(project.categoryZh || '');
  const [descriptionZh, setDescriptionZh] = useState(project.descriptionZh || '');
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Chinese fields
      setTitleZh(project.titleZh || '');
      setLocationZh(project.locationZh || '');
      setSubtitleZh(project.subtitleZh || '');
      setCategoryZh(project.categoryZh || '');
      setDescriptionZh(project.descriptionZh || '');
    }
  }, [isOpen, project]);
        ...
        <div className="overflow-y-auto p-6 space-y-6">
          <form id="edit-project-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-b border-stone-800 pb-4 mb-4">
                <h3 className="text-stone-400 text-sm font-bold uppercase tracking-widest mb-4">Deutsch</h3>
                ...
                <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest">Untertitel / Zusatzinfo</label>
                <input 
                    type="text" 
                    value={subtitle}
            ...
            {/* Chinese Fields */}
            <div>
                <h3 className="text-stone-400 text-sm font-bold uppercase tracking-widest mb-4">Chinesisch (Optional)</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest">Titel (CN)</label>
                    <input 
                    type="text" 
                    value={titleZh}
                ...
                <div className="space-y-2">
                    <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest">Standort (CN)</label>
                    <input 
                    type="text" 
                    value={locationZh}
                ...
                <div className="space-y-2 mt-4">
                <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest">Untertitel (CN)</label>
                <input 
                    type="text" 
                    value={subtitleZh}
                ...
                <div className="space-y-2 mt-4">
                    <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest">Kategorie (CN)</label>
                    <input 
                    type="text" 
                    value={categoryZh}
                ...
                <div className="space-y-2 mt-4">
                <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest">Beschreibung (CN)</label>
                <textarea 
                    rows={6}
                    value={descriptionZh}
