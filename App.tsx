...
const App: React.FC = () => {
  ...
  const [logoSrc, setLogoSrc] = useState('https://cdn.jsdelivr.net/gh/kyqdcn/Website-Y-Architektur@main/public/images/logo-Ya.png');
  const [portraitSrc, setPortraitSrc] = useState('https://cdn.jsdelivr.net/gh/kyqdcn/Website-Y-Architektur@main/public/images/Portrait-1.jpg');
      ...
      <footer className="bg-stone-950 text-stone-500 py-24 px-6 border-t border-stone-800">
        <div className="max-w-[1920px] mx-auto flex flex-col md:flex-row justify-between gap-12">
            <div>
                ...
                <p className="text-sm font-light leading-relaxed max-w-xs text-stone-400 mb-6">
                ...
                <p className="text-[10px] text-stone-700 leading-tight max-w-sm">
                    Architekt Hamburg | Energieberater | Gebäudeplanung | Gebäudesanierung<br/>
                    汉堡中国建筑师 | 汉堡华人建筑师 | 节能咨询专家 | 建筑设计及施工设计 | 旧房改造
                </p>
            </div>
